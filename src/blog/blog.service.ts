import { BadRequestException, HttpCode, HttpStatus, Inject, Injectable, NotFoundException } from '@nestjs/common';
...
export class BlogService {
	...
	async delete(id: string) {
		...
		if (result.deletedCount === 0) throw new NotFoundException('blog not found');
	}
